...
class DynaQWorker(mp.Process):
    ...
    def __init__(self, id, env, state_size, action_size, n_episodes, lr, gamma, update_every,global_network, target_network, q, max_t=1000, eps_start=1.0, eps_end=0.01, eps_decay=0.995):
